...
\centerline{\includegraphics[scale=0.4]{ACC-0001-design}}
~ \newline

\bbsubsection{Currency Selection Screen}{currency-selection-screen}
\centerline{\includegraphics[scale=0.4]{ACC-0001-2-design}}