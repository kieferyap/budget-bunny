...
struct Constants {
    struct Colors {
        ...
        static let LightGreen = UIColor(red: 63.0/255.0, green: 195.0/255.0, blue: 128.0/255.0, alpha: 1.0)
        static let DarkGreen = UIColor(red: 22.0/255.0, green: 160.0/255.0, blue: 133.0/255.0, alpha: 1.0)
